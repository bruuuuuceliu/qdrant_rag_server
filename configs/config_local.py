...
DEFAULT_ENV: dict[str, str] = {
    ...
    "RAG_INGEST_JOB_DB_PATH": "/var/lib/rag/ingestion_jobs.db",
    ...
    "WORKFLOW_LOG_DB_PATH": "/var/lib/rag/workflow_log.db",
