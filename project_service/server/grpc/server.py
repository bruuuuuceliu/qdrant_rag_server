"""Async gRPC server for the retrieval service."""
...
from project_service.gateway.errors import GatewayError
...
class RagServiceServicer(retrieval_service_pb2_grpc.RagServiceServicer):
    """Async gRPC servicer delegating to the gateway and engine."""
...
def _search_result_to_proto(result: SearchResult) -> retrieval_service_pb2.SearchResponse:
    chunks = [
