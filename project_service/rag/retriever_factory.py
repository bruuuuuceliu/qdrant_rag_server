"""Project-level retriever selection."""

from __future__ import annotations

from project_service.rag.retrieval_config import ProjectRetrievalSettings
...
class ProjectRetrieverFactory:
    """Select low-level retrievers from project retrieval settings."""
